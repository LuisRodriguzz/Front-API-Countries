...
export default function CardActivityCreator() {
  ...
  function handleSubmit(e) {
    console.log(e, 'estoy en handle submit')
    e.preventDefault();
    if (!input.name) alert('Name is need')
    else if (!input.difficulty) alert('Choose difficulty.')
    else if (!input.duration) alert('Choose a duration.')
    else if (!input.season) alert('Choose a season.')
    else if (!input.countries.length) alert('Choose a country.')
    else {
      e.preventDefault();
      setErrors(validate({
        ...input,
  ...
  function handleDelete(e) {
    console.log(e, 'estoy en handledelete')
    setInput({
      ...input,
  ...
  return (
    <div className='createbg'>
      ...
      <div className='cntcreate'>
      <form className= 'tblaActivity' onSubmit={(e) => handleSubmit(e)}>
        ...
        <div>
          ...
          {errors.name || !input.name || !input.difficulty || !input.duration || !input.season || !input.countries.length || Object.entries(errors).length 
            ? <button className='btncreate' type="submit" disabled={false}>CREATE</button>
